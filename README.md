...
```bash
git clone https://github.com/Arun02DS/aps-fault-detection.git
```
...
export MONGODB_URL="mongodb+srv://arun:<password>@arun.wpyhw.mongodb.net/?retryWrites=true&w=majority"
